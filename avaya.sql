-- Nortel Avaya 4548gt & 4850GTS
-- plugin_id: 9225


DELETE FROM plugin WHERE id = "9225"; 
DELETE FROM plugin_sid where plugin_id = "9225";
DELETE FROM software_cpe where plugin = 'avaya:9225';

INSERT IGNORE INTO plugin (id, type, name, description, product_type, vendor) VALUES (9225, 1, 'avaya', 'avaya', '24', 'avaya');
...
INSERT IGNORE INTO software_cpe (cpe, name, version, line, vendor, plugin) VALUES ('cpe:/o:avaya:4548gt_switch:4548gt', 'avaya','4548gt','avaya 4548gt','avaya', 'avaya:9225');
